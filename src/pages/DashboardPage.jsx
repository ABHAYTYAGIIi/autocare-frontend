...
export function DashboardPage({ navigate }) {
  ...
  return <><PageHeader title="Operations dashboard" description="Your service desk at a glance. - Autocare workshop demo." action={<button className="button button-primary" onClick={() => navigate("bookings")}><Icon name="plus" size={18} />New booking</button>} />
